...
using UnityEditor;
	...
	public class MinMaxSliderDrawer : PropertyDrawer {
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
			MinMaxIntAttribute minMaxAttr = attribute as MinMaxIntAttribute;
		...
		protected void DrawMinMaxSlider(Rect position, GUIContent label, MinMaxIntAttribute minMaxAttr, SerializedProperty minProperty, SerializedProperty maxProperty) {
			float textWidth = 30f;
		...
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label) {
			MinMaxIntAttribute minMax = attribute as MinMaxIntAttribute;
