...
namespace PivecLabs.GameCreator.VisualScripting
{
	...
	[CustomPropertyDrawer(typeof(InstructionPlayRandomAmbientFromList))]

public class InstructionPlayRandomAmbientFromListDrawer : PropertyDrawer
{
		private SerializedProperty array1;
		private SerializedProperty arraySize;
		private void OnGUIHandler()
			{
			EditorGUILayout.LabelField("Audio List");
