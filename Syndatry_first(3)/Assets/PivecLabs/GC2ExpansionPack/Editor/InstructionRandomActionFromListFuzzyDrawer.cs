...
namespace PivecLabs.GameCreator.VisualScripting
{
	...
	[CustomPropertyDrawer(typeof(InstructionRandomActionFromListFuzzy))]

public class InstructionRandomActionFromListFuzzyDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		ArrayGUI(m_Property, "Action Container ", true);
