...
namespace PivecLabs.GameCreator.VisualScripting
{
    ...
    [Version(1, 0, 1)]
    [Title("Drag Object by RigidBody with Mouse")]
    [Description("Drag Object by RigidBody with Mouse")]
    [Category("Physics 3D/Drag Object by RigidBody with Mouse")]

    [Parameter("targetObject", "The Game Object with RigidBody to be Dragged")]
    ...
    public class InstructionDragObjectByRigidBody : Instruction
    {
	  ...
	  [SerializeField] private GameObject targetObject;
        ...
        public override string Title => "Drag Object by RigidBody with Mouse";
	    private Mouse mouse;
		...
		Rigidbody GetRigidbodyFromMouseClick()
		{
			...
			{
				if ((hit.collider.gameObject.GetComponent<Rigidbody>()) && (hit.transform.name == targetObject.name))
				{
