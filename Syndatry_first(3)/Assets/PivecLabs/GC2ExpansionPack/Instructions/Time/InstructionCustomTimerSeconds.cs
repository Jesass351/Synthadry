...
namespace PivecLabs.GameCreator.VisualScripting
{
    ...
    [Version(1, 0, 1)]
    [Title("Custom Timer in Seconds")]
    [Description("Custom Timer for calling Actions and Conditions")]
    [Category("Time/Custom Timer in Seconds")]
	...
	public class InstructionCustomTimerSeconds : Instruction
    {
	    [SerializeField][Range(1f, 90f)]private float m_Seconds = 10.0f;
	    ...
	    public override string Title => "Custom Timer in Seconds";


	    protected override async Task Run(Args args)
		{
			float value = (float) this.m_Seconds;
