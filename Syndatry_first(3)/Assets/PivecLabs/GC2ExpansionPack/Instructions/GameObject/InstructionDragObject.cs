...
namespace PivecLabs.GameCreator.VisualScripting
{
    ...
    [Version(1, 0, 1)]
    [Title("Drag Object with Mouse")]
    [Description("Drag Object with Mouse")]
    [Category("Game Objects/Drag Object with Mouse")]

    [Parameter("targetObject", "The Game Object to be Dragged")]
    ...
    public class InstructionDragObject : Instruction
    {
	  ...
	  [SerializeField] private GameObject targetObject;
        ...
        public override string Title => "Drag Object with Mouse";
	    private Mouse mouse;
        ...
        protected override  Task Run(Args args)
	    {
			...
			RaycastHit hit;
			    ...
			    {
				    if (hit.transform.name == targetObject.name)
				    {
				...
				if (dragging == true) 
				{
					...
					if ((restrictDragging == true) && (hit.transform.name == targetObject.name))
					{
						if (xAxis == true)
						{
					...
					else if (hit.transform.name == targetObject.name)
					{
