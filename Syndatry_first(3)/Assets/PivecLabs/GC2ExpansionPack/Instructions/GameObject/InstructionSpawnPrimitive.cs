...
[Version(1, 0, 1)]
[Title("Spawn Primitive at Position")]
[Description("Spawns a Primitive at the specified position")]
[Category("Game Objects/Spawn Primitive at Position")]
...
[Serializable]
public class InstructionSpawnPrimitive : Instruction
{
	public override string Title => $"Spawn Primitive {this.primitiveType} to {this.position}";
